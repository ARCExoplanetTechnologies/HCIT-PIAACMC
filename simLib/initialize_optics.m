  ...
  elseif strcmp(optics.elem(iElem).elemType, 'PreFPM')
   ...
   elseif strcmp(optics.elem(iElem).elemType, 'PIAA')
       if (strcmp(optics.elem(iElem).elemName, 'Forward') ...
            ...
            rt = transpose(pup(:,1)/max(pup(:,1)))/2;
            drt = rt(2) - rt(1);
            ...
            %ff = interp1(rt,f,pupil.rr,'spline',0).*(pupil.rr<(pupil.D/2));
            PIAA.M2.pupilMask = ((pupil.rr > pupil.Dobs/2).*(pupil.rr < pupil.D/2) + 0.0);
            ff = interp1(rt,f,pupil.rr,'spline',0).*PIAA.M2.pupilMask;
            ...
            PIAA.M2 = PIAA.M1;
            PIAA.M2.ff = ff;
            PIAA.M2.r = rM2_rM1(:,1)*optics.elem(iElem).Dx;
            PIAA.M2.remap = rM2_rM1(:,2)*optics.elem(iElem).Dx;
