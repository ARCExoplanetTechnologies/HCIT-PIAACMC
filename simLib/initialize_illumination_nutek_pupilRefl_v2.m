function [illumination,illuminationOptics] = initialize_illumination_nutek_pupilRefl_v2(system,x,y,thisR)
...
if system.illumParams.illumination.downsample == true
    ...
    pupilElemNum = 1;
    blackInds = find(system.optics.elem(pupilElemNum).AA < 1e-5);
    system.optics.elem(pupilElemNum).AA(blackInds) = thisR;
end
