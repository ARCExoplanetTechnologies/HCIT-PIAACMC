...
if system.illumParams.illumination.downsample == true
    ...
    system.optics.elem(1).AA = fitsread('opticalElements\luvoirApiaacmc\openPup2048.fits')
    system.optics.elem(2).AA = fitsread('opticalElements\luvoirApiaacmc\openPup2048.fits')
    %system.optics.elem(3).surfaceAberrations = fitsread(system.params.illumination.pupilSurf);
    system.optics.elem(3).surfaceAberrations = fitsread('opticalElements\luvoirApiaacmc\zeros_n2048.fits')
    system.optics.elem(4).surfaceAberrations = fitsread('opticalElements\luvoirApiaacmc\zeros_n2048.fits');
	system.optics.elem(5).AA = fitsread('opticalElements\luvoirApiaacmc\openPup2048.fits')
    system.optics.elem(6).surfaceAberrations = fitsread('opticalElements\luvoirApiaacmc\zeros_n2048.fits');
